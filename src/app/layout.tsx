  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="peluqueria-barberia-josue";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Peluquería- Barbería Josue"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="peluqueria-barberia-josue"
          data-primary-color="#1a190c"
          defer
        ></script>
      </head>
